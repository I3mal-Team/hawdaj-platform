            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('dashboard.application-categories.create')}}"
                        ...
                        @if(!empty($categories->first()))
                            @foreach($categories as $index => $category)
                                ...
                                <td>{{($index + 1) + ((request('page' , 1)-1) * request('per_page' , 10)) }}</td>
                                    ...
                                    <td>
                                        <a href="{{route('dashboard.application-categories.edit', $category->id)}}"
                                        ...
                                        <a class="btn btn-sm btn-clean btn-icon btn-icon-md delete-button"
                                           ...
                                           data-url="{{ route('dashboard.application-categories.destroy',$category->id) }}"
