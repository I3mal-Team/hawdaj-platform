                            ...
                            <div class="card card-custom card-border text-center mb-4 layout">
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <div class="col-2">
                                            <img class="mb-2 min-w-50px min-h-25px" src="{{ url('/dashboard_assets/logo/new_logo.png') }}" alt="" width="10%">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="titels mb-4">
                                        <h5 class="text-cust-head mb-4">
                                            <b>{{ __('dashboard.welcome') }} {{ $data['driver_name'] }}</b></h5>
                                        <div class="mt-3"></div>
                                        <p class="text-cust-head">
                                            Your Car Request has been <strong>confirmed</strong> with:
                                        </p>
                                    </div>
                                    <div class="logo mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p><b>Start: </b>{{ dateFormat($data['carRequest']->delivery_date) }}</p>
                                        </div>
                                        <div class="col-6">
                                            <p><b>From: </b>{{ timeFormat($data['carRequest']->delivery_from_time) }}
                                            </p>
                                        </div>
                                        <div class="col-6">
                                            <p><b>To: </b>{{ timeFormat($data['carRequest']->delivery_to_time) }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <span><b>#Driver Request ID</b></span> |
                                            <b>{{$data['car_request_id']}}</b>
                                            @php
                                                $image = $data['car_request_id'].time().'.svg';
                                                $qr_image = \QrCode::size(50)
                                                            ->format('svg')
                                                            ->generate($data['car_request_id'], $image);
