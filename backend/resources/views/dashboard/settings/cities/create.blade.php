...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-region breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.cities.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.city_name')</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="city" class="form-control select2" name="region_id">
