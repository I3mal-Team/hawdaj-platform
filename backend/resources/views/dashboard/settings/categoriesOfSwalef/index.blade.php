...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="javascript:;" class="text-muted">@lang('dashboard.swalef')</a>
        </li>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('dashboard.swalef-categories.create')}}"
                        ...
                        @if(!empty($categories->first()))
                            @foreach($categories as $index => $category)
                                ...
                                <td>{{($index + 1) + ((request('page' , 1)-1) * request('per_page' , 10)) }}</td>
                                    ...
                                    <td>
                                        <a href="{{route('dashboard.swalef-categories.edit', $category->id)}}"
                                        ...
                                        <a class="btn btn-sm btn-clean btn-icon btn-icon-md delete-button"
                                           ...
                                           data-url="{{ route('dashboard.swalef-categories.destroy',$category->id) }}"
