...
@Component({
  ...
  templateUrl: './quick-global-search.component.html',
  styleUrls: ['./quick-global-search.component.scss']
})
export class QuickGlobalSearchComponent {
