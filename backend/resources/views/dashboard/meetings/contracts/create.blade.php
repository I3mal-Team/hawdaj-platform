...
<div class="col-12" style="background-color: #FFFFFF">
    ...
    @if($contractorRequest->status == null)
        <div class="card-body" id="ContractVisitInfo" style="padding: 0.25rem !important;">
                            ...
                            <div class="wizard-steps d-flex flex-column flex-md-row">
                                ...
                                <div class="wizard-step flex-grow-1 flex-basis-0"
                                    ...
                                    <div class="wizard-wrapper pr-lg-7 pr-5">
                                        ...
                                        <div class="wizard-label mr-3">
                                            <h3 class="wizard-title">{{ __('dashboard.visit_info') }}</h3>
                                            <div
                                                class="wizard-desc">{{ __('dashboard.user_details') }}</div>
                                        </div>
                                        <span class="svg-icon">
                                ...
                                <div class="wizard-step flex-grow-1 flex-basis-0"
                                    ...
                                    <div class="wizard-wrapper pr-lg-7 pr-5">
                                        ...
                                        <div class="wizard-label mr-3">
                                            <h3 class="wizard-title">{{ __('dashboard.personal_info') }} </h3>
                                            <div
                                                class="wizard-desc">{{ __('dashboard.personal_info') }}</div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                            <h3 class="wizard-title">{{ __('dashboard.other_info') }}</h3>--}}
{{--                                            <div--}}
{{--                                                class="wizard-desc">{{ __('dashboard.other_info') }}</div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                    ...
                    <form class="px-10 fv-plugins-bootstrap fv-plugins-framework"
                          novalidate="novalidate" id="contractor_form">
                        <input type="hidden" class="form-control" name="contractor_id"
                               value="{{ $contractorRequest->contractor->id }}">
                        <input type="hidden" class="form-control" name="contractor_request_id"
                               value="{{ $contractorRequest->id }}">
                        <!--begin: Wizard Step 1-->
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                        @include('dashboard.meetings.contracts.steps.permission')
                        <!--end::Form Group-->
                        </div>
                        <!--end: Wizard Step 1-->
                        <!--begin: Wizard Step 2-->
                        <div class="pb-5" data-wizard-type="step-content">
                            @include('dashboard.meetings.contracts.steps.personal')
                        </div>
                        <!--end: Wizard Step 2-->
                        <!--begin: Wizard Step 3-->
{{--                        <div class="pb-5" data-wizard-type="step-content">--}}
{{--                            @include('dashboard.meetings.steps.questions')--}}
{{--                        </div>--}}
                        <!--end: Wizard Step 3-->
    ...
    @elseif(in_array($contractorRequest->status,['confirmed','approve','monitor']))
        <div id="ContractVisitConfirm" class="card-body">
            <div class="text-center pt-10 mb-10">
                <h1 class="h2 font-weight-bolder text-dark mb-6">All is Good</h1>
                <div class="h3 text-dark-50 font-weight-bold mb-5">
                    Your metting has been Confirmed check your mail for more details
                </div>
                <div class="row">
    ...
    @elseif($contractorRequest->status == 'cancel')
        <div id="ContractVisitConfirm" class="card-body">
            <div class="text-center pt-10 mb-10">
                <h1 class="h2 font-weight-bolder text-dark mb-6">All is Good</h1>
                <div class="h3 text-dark-50 font-weight-bold mb-5">
                    Your metting has been Canceled Successfully
                </div>
                <div class="row">
                    <div class="offset-md-3 col-md-6">
                        <span class="svg-icon svg-icon-full">
    ...
    @endif
    <div id="ContractVisitConfirm" class="card-body" style="display: none">
        <div class="text-center pt-10 mb-10">
            <h1 class="h2 font-weight-bolder text-dark mb-6">All is Good</h1>
            <div class="h3 text-dark font-weight-normal mb-5 mt-10">
                Your metting has been Confirmed check your mail fo more details
            </div>
            <div class="row">
                <div class="offset-md-3 col-md-6">
                            <span class="svg-icon svg-icon-full">
...
<script src="{{asset('dashboard_assets/custom/js/contractMettingRequest.js')}}" type="text/javascript"></script>
