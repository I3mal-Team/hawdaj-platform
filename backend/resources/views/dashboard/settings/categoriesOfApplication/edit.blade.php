...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="javascript:;" class="text-muted">@lang('dashboard.applications')</a>
        </li>

        <li class="breadcrumb-item text-muted">
            <a href="{{route('dashboard.application-categories.index')}}" class="text-muted">@lang('dashboard.categories')</a>
        </li>
        <li class="breadcrumb-item text-muted">
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.application-categories.update' , $category->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.category_name')</label>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" value="{{ $category->translate(default_lang())->name ?? '' }}"
                                        ...
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}"
                                                          ...
                                                          placeholder="@lang('dashboard.enter') @lang('dashboard.notes') ">{{ $category->translate(default_lang())->notes ?? ''  }}</textarea>
                                                <div class="invalid-feedback">
                                    ...
                                    @include('dashboard.includes.partials._order_id_field', ['orderIdModel' => $category])
