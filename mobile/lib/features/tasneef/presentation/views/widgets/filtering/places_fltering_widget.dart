...
List<FilterModel> _placesFilterModel(
  ...
  FilterModel.placeName(nameController),
...
class PlacesFilteringWidget extends StatefulWidget {
  const PlacesFilteringWidget({super.key});

  @override
  State<PlacesFilteringWidget> createState() => _PlacesFilteringWidgetState();
}

class _PlacesFilteringWidgetState extends State<PlacesFilteringWidget> {
