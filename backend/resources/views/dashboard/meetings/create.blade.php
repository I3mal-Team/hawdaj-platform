...
<div class="col-12" style="background-color: #FFFFFF">
            ...
            <div class="wizard wizard-6 d-flex flex-column flex-lg-row flex-column-fluid" id="kt_wizard"
                ...
                <div class="wizard-content d-flex flex-column mx-auto py-10 py-lg-5 w-100">
                    ...
                    <form class="px-10 fv-plugins-bootstrap fv-plugins-framework"
                        ...
                        <input type="hidden" class="form-control" name="visitor_id"
                               value="{{ $visitorRequest->visitor->id }}">
                        <input type="hidden" class="form-control" name="visitor_request_id"
                               value="{{ $visitorRequest->id }}">
                        <!--begin: Wizard Step 1-->
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                        @include('dashboard.meetings.steps.permission')
                        <!--end::Form Group-->
                        </div>
                        <!--end: Wizard Step 1-->
                        <!--begin: Wizard Step 2-->
                        <div class="pb-5" data-wizard-type="step-content">
                            @include('dashboard.meetings.steps.personal')
                        </div>
                        <!--end: Wizard Step 2-->
                        <!--begin: Wizard Step 3-->
                        <div class="pb-5" data-wizard-type="step-content">
    ...
    @elseif(in_array($visitorRequest->status,['confirmed','approve','monitor']))
        <div id="VisitConfirm" class="card-body">
    ...
    @elseif($visitorRequest->status == 'cancel')
        <div id="VisitConfirm" class="card-body">
            <div class="text-center pt-10 mb-10">
                <h1 class="h2 font-weight-bolder text-dark mb-6">All is Good</h1>
                <div class="h3 text-dark-50 font-weight-bold mb-5">
    ...
    @endif
    <div id="VisitConfirm" class="card-body" style="display: none">
        <div class="text-center pt-10 mb-10">
            <h1 class="h2 font-weight-bolder text-dark mb-6">All is Good</h1>
...
<script src="{{asset('dashboard_assets/custom/js/mettingRequest.js')}}" type="text/javascript"></script>
