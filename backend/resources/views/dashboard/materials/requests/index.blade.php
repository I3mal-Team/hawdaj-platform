...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <a href="javascript:;" class="">@lang('dashboard.materials_requests')</a>
        </li>
        <li class="breadcrumb-item text-muted">
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-2 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">@lang('dashboard.materials_requests_list')</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{url('dashboard/material-requests/create')}}"
