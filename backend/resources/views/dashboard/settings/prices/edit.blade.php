...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('setting/prices')}}" class="text-muted">@lang('dashboard.prices')</a>
        </li>
        <li class="breadcrumb-item text-muted">
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.prices.update' , $price->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" value="{{ $price->translate(default_lang())->name ?? ''  }}"
                                    ...
                                    @include('dashboard.includes.partials._order_id_field', ['orderIdModel' => $price])
