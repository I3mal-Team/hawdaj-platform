...
@section('page_header')
    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('dashboard.profile_info')</h5>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item text-muted">
            <a href="javascript:;" class="text-muted">{{auth()->user()->full_name??'---'}}</a>
        </li>
    </ul>
@endsection
                                ...
                                <div class="navi-item mb-2">
                                    <a href="{{route('dashboard.profile.index')}}"
                                       class="navi-link py-4 {{ request()->is('*/profile') ? 'active' : '' }} ">
                                        ...
                                        <span
                                            class="navi-text font-size-lg">{{__('dashboard.personal_info')}}</span>
                                    </a>
                                </div>
                                <div class="navi-item mb-2 ">
                                    <a href="{{route('dashboard.profile.changePassword')}}"
                                       class="navi-link py-4 {{ request()->is('*/profile/changePassword') ? 'active' : '' }}">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-dashboard.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                     width="24px" height="24px" viewBox="0 0 24 24"
                                                     version="1.1">
                                        ...
                                        <span class="navi-text font-size-lg">{{__('dashboard.change_password')}}</span>
