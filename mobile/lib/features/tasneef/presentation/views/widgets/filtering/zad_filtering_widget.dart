...
List<FilterModel> _filterModel(
  ...
  FilterModel.foodCategory(categoryModel, onCategorySelected),
];

class ZadFilteringWidget extends StatefulWidget {
  const ZadFilteringWidget({super.key});

  @override
  State<ZadFilteringWidget> createState() => _ZadFilteringWidgetState();
}

class _ZadFilteringWidgetState extends State<ZadFilteringWidget> {
                  ...
                  switch (filter.key) {
                    ...
                    case 'food_categories':
                      if (categoryModel != null) {
                        filterParams[filter.key] = categoryModel!;
                      }
                      break;
                  }
                }
