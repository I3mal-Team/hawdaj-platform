...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('setting/features')}}" class="text-muted">@lang('dashboard.features')</a>
        </li>
        <li class="breadcrumb-item text-muted">
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.features.update' , $feature->id) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="name" value="{{$feature->translate(default_lang())->name}}" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="@lang('dashboard.enter') @lang('dashboard.name') ">
                                        ...
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text"
                                                          ...
                                                          placeholder="@lang('dashboard.enter') @lang('dashboard.description')">{{ $feature->translate(default_lang())->description}}</textarea>
                                                <div class="invalid-feedback">
