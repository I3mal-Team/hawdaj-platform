...
import { IStoreItem } from './../../../../interfaces/home';
...
@Component({
  selector: 'app-animated-image-slider-v2',
  standalone: true,
  imports: [CommonModule, TranslateModule, RouterModule, NgOptimizedImage, LazyLoadImageDirective, StripHtmlPipe],
  templateUrl: './animated-image-slider-v2.component.html',
  styleUrls: ['./animated-image-slider-v2.component.scss']
})
export class AnimatedImageSliderV2Component implements OnInit, OnDestroy {
  ...
  @Input() items: IStoreItem[] = [];  // This should be populated with the actual interface structure.
