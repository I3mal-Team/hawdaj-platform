        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-custom gutter-b">
                    ...
                    <form method="post" action="{{ route('dashboard.sliders.store') }}" enctype="multipart/form-data" class="kt-form kt-form--label-right">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group validated">
                                        ...
                                        <input type="text" name="link" value="{{ old('link') }}" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" placeholder="https://">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="order_id" value="{{ old('order_id', 0) }}" class="form-control {{ $errors->has('order_id') ? 'is-invalid' : '' }}" min="0">
