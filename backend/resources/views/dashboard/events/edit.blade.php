...
{{--            myLatLng = {--}}
{{--                lat: {{ $data->lat ?? '24.774265' }},--}}
{{--                lng: {{ $data->long ?? '46.738586' }}--}}
{{--            };--}}
...
{{--                google.maps.event.addListener(marker, 'dragend', function(evt) {--}}
{{--                    document.getElementById('current').innerHTML = '<p>Marker dropped: Current Lat: ' + evt--}}
{{--                        .latLng.lat().toFixed(3) + ' Current Lng: ' + evt.latLng.lng().toFixed(3) + '</p>';--}}
                                    ...
                                    <div class="card-body custom-nav">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="related-tab" data-toggle="tab" href="#related">
                                                    <span class="nav-icon"><i
                                                            class="flaticon2-heart-rate-monitor"></i></span>
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="info" role="tabpanel"
                                                aria-labelledby="info-tab">@include('dashboard.events.includes._global_edit')</div>
                                            ...
                                            <div class="tab-pane fade show" id="related" role="tabpanel"
                                                aria-labelledby="location-tab">@include('dashboard.events.includes._global_related')</div>
                                        </div>
