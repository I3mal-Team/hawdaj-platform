                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group validated">
                                ...
                                <div class="input-group">
                                    <input type="text" name="ceo_title" value="{{ $data->ceo->title ?? ''}}"
                                           class="form-control {{ $errors->has('ceo_title') ? 'is-invalid' : '' }}"
                                           placeholder="@lang('dashboard.enter') @lang('dashboard.title') "
                                           aria-describedby="basic-addon1">
                                    <div class="invalid-feedback">
                                        <strong>{{ $errors->has('ceo_title') ? $errors->first('ceo_title') : '' }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group validated">
                                ...
                                <div class="input-group">
                                            <textarea
                                                class="form-control description-seo {{ $errors->has('ceo_description') ? 'is-invalid' : '' }}"
                                                name="ceo_description" rows="5"> {{ $data->ceo->description ?? '' }} </textarea>
                                    <div class="invalid-feedback">
                                        <strong>{{ $errors->has('ceo_description') ? $errors->first('ceo_description') : '' }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group validated">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="type" value="{{ Request::segment(2) }}" id="">
