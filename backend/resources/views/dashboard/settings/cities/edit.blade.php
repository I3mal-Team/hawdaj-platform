...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('setting/cities')}}" class="text-muted">@lang('dashboard.cities')</a>
        </li>
        <li class="breadcrumb-item text-muted">
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.cities.update' , $city->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" value="{{ $city->translate(default_lang())->name ?? ''  }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="city" class="form-control select2"
                                                    name="region_id">
                                                <option value="">@lang('dashboard.select_region')</option>
