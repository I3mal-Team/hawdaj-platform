...
@Component({
  ...
  ], templateUrl: './my-trips-list-v2.component.html',
  styleUrls: ['./my-trips-list-v2.component.scss']
})
export class MyTripsListV2Component {
  ...
  changePage(direction: number) {
    if (direction === -1 && this.page > 1) {
      this.page--;
    } else if (direction === 1 && this.page < Math.ceil(this.totalTripsCount / this.perPage)) {
      this.page++;
