...
import { Component, EventEmitter, inject, Inject, Input, Output, PLATFORM_ID, SimpleChanges, ViewEncapsulation } from '@angular/core';
import { PlacesService } from '../../../../services/places.service';
import { AlertsService } from 'src/app/services/alerts.service';
import { Price } from '../../../../interfaces/create-trip';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatStepperModule, TranslateModule, FormsModule, ReactiveFormsModule, MatSliderModule],
